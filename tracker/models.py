...
class Habit(models.Model):
    ...
    time = models.TimeField(default='12:00', null=True, blank=True, verbose_name='Время')
    ...
    duration = models.IntegerField(default=2, null=True, blank=True, verbose_name='Время на выполнение в минутах')
    public = models.BooleanField(default=False, null=True, blank=True, verbose_name='Признак публичности')
    last_reminder_date = models.DateTimeField(default=timezone.now, verbose_name='дата последнего напоминания')
